...
import 'package:my_bsava_app/Data/constant_data.dart';
import 'package:my_bsava_app/Utils/loading_indicator.dart';
...
class _ReaderState extends State<Reader> {
          ...
          new Expanded(
            child: new Container(
              ...
              child: Container(
                child: 
                  new HtmlView(
                data: lightEngine.getContent(index), 
              ),
              ),
              // child: new Text(
                    ...
                    return 
                        PageView.custom(
                            childrenDelegate: new SliverChildBuilderDelegate(
                                pageBuilder,
                                // childCount: lightEngine.childCount, //testing
  ...
  Row bottomNav() {
    return Row(
        ...
        children: <Widget>[
          IconButton(
              icon: Icon(Icons.home, color: Constants.bsavaOrange),
              onPressed: () {}),
          IconButton(
              icon: Icon(Icons.view_headline, color: Constants.bsavaOrange),
              onPressed: () {}),
          IconButton(
              icon: Icon(Icons.arrow_back, color: Constants.bsavaOrange),
              onPressed: () {}),
          IconButton(
              icon: Icon(Icons.arrow_forward, color: Constants.bsavaOrange),
              onPressed: () {}),
          IconButton(
              icon: Icon(Icons.bookmark_border, color: Constants.bsavaOrange),
              onPressed: () {}),
        ]);
  }
